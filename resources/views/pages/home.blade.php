...
<div class="site-wrapper-reveal"  >
    ...
    <div class="about-us-area section-space--ptb_120" >
        <div class="container">
            <div class="row">
                <div class="col-lg-12" >
                    <div class="about-us-content_6 text-center text-color-primary">
                        <h2 class="text-color-primary">Medical Device;&nbsp;Store</h2>
                        <p>
                            <small>
    ...
    <div class="our-member-area section-space--pb_120">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="member--box" style="background-color: #EDF2F6;">
