                ...
                template += `   <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="single-product-item text-center">
                                        <div class="products-images">
                                            <a href="/medic/` + item.id + `" class="product-thumbnail">
                                                 <img src="` + item.cover + `" alt="Product Images" height="200" style="border: 4px solid #5ee885; border-radius: 15px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.3);">
                                            </a>
                                            <div class="product-actions">
                                                <a href="/medic/` + item.id + `"><i class="p-icon icon-plus" ></i><span class="tool-tip">Quick View</span></a>
                                                <a href="#"><i class="p-icon icon-bag2"></i> <span class="tool-tip">Add to cart</span></a>
                                            </div>
                                        </div>
                                        <div class="product-content">
                                            <h6 class="product-title">
                                                <a href="/medic/` + item.id + `">` + item.equipment_name + `</a>
                                            </h6>
