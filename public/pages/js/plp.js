    ...
    axios.get(url, { params: payload }, apiHeaders)
        .then(function (response) {
            ...
            if (response.data.products && response.data.products.length > 0) {
                ...
                $(id_el_list).html('<div class="col-12 text-center">No products found.</div>');
            }
            // END - products
            ...
            template = '';
            let max_page = Math.ceil(response.data.products_count_total / response.data.filter_limit);
